...
creating them upfront — they're written as terms and decisions actually get resolved.
...
language the project doesn't use (reconsider) or there's a real gap (note it for a future
`CONTEXT.md` update).
