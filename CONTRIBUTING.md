...
are no other committers.

Reviews and responses are best-effort, with no SLA. A PR may sit for a while before it's looked
at; that's expected, not neglect.
...
A PR that weakens this boundary is rejected regardless of how valuable the feature is.
